        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-muted-foreground mb-6 text-sm">
              Transform raw footage into viral-ready videos with AI-powered editing and real-time collaboration.
            </p>
          ...
          <div>
            <h3 className="text-sm uppercase text-foreground/70 tracking-wider mb-4">Product</h3>
            <ul className="space-y-2">
              ...
              <li><Link to="/effects" className="text-muted-foreground hover:text-primary transition-colors text-sm">Effects Library</Link></li>
            </ul>
          </div>
          
          {/* Column 3: Resource Links */}
          <div>
            <h3 className="text-sm uppercase text-foreground/70 tracking-wider mb-4">Resources</h3>
            <ul className="space-y-2">
              <li><Link to="/documentation" className="text-muted-foreground hover:text-primary transition-colors text-sm">Documentation</Link></li>
              <li><Link to="/tutorials" className="text-muted-foreground hover:text-primary transition-colors text-sm">Tutorials</Link></li>
          ...
          <div>
            <h3 className="text-sm uppercase text-foreground/70 tracking-wider mb-4">Company</h3>
            <ul className="space-y-2">
